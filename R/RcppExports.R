...
pMu <- function(betahat, serr, pi, tau) {
    .Call('RColumbo_pMu', PACKAGE = 'RColumbo', betahat, serr, pi, tau)
}

sslab_em <- function(p, bh, si) {
    .Call('RColumbo_sslab_em', PACKAGE = 'RColumbo', p, bh, si)
}
