...
write_genotype_h5 <- function(snpdatmat, Nind, Nsnps, chunksize, h5file, doFlip, dbsnpfile) {
    .Call('RColumbo_write_genotype_h5', PACKAGE = 'RColumbo', snpdatmat, Nind, Nsnps, chunksize, h5file, doFlip, dbsnpfile)
}
