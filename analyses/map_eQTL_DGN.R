...
dgn_covarbf <- "/media/nwknoblauch/Data/DGN/Lev/covariates/Biological_and_hidden_factors.txt"
dgn_covartf <- "/media/nwknoblauch/Data/DGN/Lev/covariates/Technical_factors.txt"
f_DGN_geno_h5 <- "/media/nwknoblauch/Data/DGN/Lev/eQTL/DGN_geno_exp.h5"
ortho_DGN <- "/media/nwknoblauch/Data/DGN/Lev/eQTL/DGN_ortho.h5"
dgn_expf <- "/media/nwknoblauch/Data/DGN/Lev/data_used_for_eqtl_study/cis_iso_data.txt"
dgn_gdsf <- "/media/nwknoblauch/Data/DGN/Lev/DGN.gds"




iso_dat <- read_delim(dgn_expf,delim="\t",col_names=T)
iso_dat <- rename(iso_dat,Id=X1)
