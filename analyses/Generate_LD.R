...
th5file <- "/media/nwknoblauch/Data/GTEx/chr22_1kg_Whole_Blood_HEIGHT.h5"
oh5files <- paste0("/home/nwknoblauch/Desktop/LDmats/chr",1:22,"_1kg_WB_Height_LD.h5")
foh5files <-paste0("/home/nwknoblauch/Desktop/LDmats/chr",1:22,"_1kg_WB_Height_LD_blosc.h5")
...
for(chrom in 1:21){
  ...
  for(j in 1:chunknum){
    ...
    system.time(Rwrite_blosc_cov_LD(th5file = foth5file,tdimension = nsnps,Offset = offset,data = fLDmat))
